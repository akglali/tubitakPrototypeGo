...
func sendLocation(c *gin.Context)  {
	...
	_, err = database.Db.Query("insert into patient_tracker_info_table( patient_id, beacon_id, seen_time, distance) values ($1,$2,$3,$4)", body.PatientId, body.BeaconId,currentTime,2)
